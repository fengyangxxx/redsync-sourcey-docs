...
- Reviewed publication destination: https://github.com/fengyangxxx/redsync-sourcey-docs at `refs/heads/fix/frantic33-governed-receipt-v3`; expected pre-push state is branch absent.
- Governed workflow: `.github/workflows/validate-sourcey-adoption.yml`, dispatch ref `fix/frantic33-governed-receipt-v3`.
